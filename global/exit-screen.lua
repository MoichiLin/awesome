...
local poweroff = build_button(icons.power)
...
local reboot = build_button(icons.restart)
...
local suspend = build_button(icons.sleep)
...
local exit = build_button(icons.logout)
exit:connect_signal(
   "button::release",
   function()
      exit_command()
...
local lock = build_button(icons.lock)
lock:connect_signal(
   "button::release",
   function()
      lock_command()
